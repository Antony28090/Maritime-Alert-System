...
*   ** Tamil Voice Alerts**: Integrated Text-to-Speech (TTS) provides clear audio warnings in the local language (*"Echarikkai!"*).
*   ** Real-time Dashboard**: A web-based interface (Leaflet.js) visualizing the vessel, boundary line, and predictive path.
